                    ...
                    <>
                        ...
                        <Row>
                            ...
                            <Col lg={8}>
                                ...
                                <div className="expense-list-container" style={{ maxHeight: '47vh', overflowY: 'auto', paddingRight: '10px' }}>
                                    {expenses.length === 0 ? (
                            ...
                            <Col lg={4}>
                                ...
                                <Card className="border-0 shadow-sm rounded-4 p-4 bg-white">
                                    ...
                                    <div className="text-muted small mb-2">QUICK STATS</div>
                                    <div className="d-flex justify-content-between mb-2">
                                        <span>Total Spent</span>
                                        <span className="fw-bold text-dark">₹{expenses.reduce((acc, curr) => acc + curr.totalAmount, 0).toFixed(2)}</span>
                                    </div>
                                    <div className="d-flex justify-content-between mb-2">
                                        <span>Average Per Person</span>
                                        <span className="fw-bold">
                                            ₹{(expenses.reduce((acc, curr) => acc + curr.totalAmount, 0) / (trip.participants?.length || 1)).toFixed(2)}
                                        </span>
                                    </div>
                                    <div className="d-flex justify-content-between mb-2">
